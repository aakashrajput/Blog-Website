          ...
          <?php
            ...
            <div class="col-sm-6 mas-p">
                <div class="mas-item mas-big">
                    ...
                    <div class="mas-text">
                        <div class="post-cat"><a href="posts.php?post_id=<?php echo $container_id?>"><?php echo $container_categories; ?></a></div>
                        <h2 class="mas-title"><a href="posts.php?post_id=<?php echo $container_id?>"><?php echo $container_title; ?></a></h2>
                          ...
                          <?php
                            ...
                            <div class="item mas-m-b">
                                <div class="mas-item masonry-sm">
                                    ...
                                    <div class="mas-text">
                                        <div class="post-cat"><a href="posts.php?post_id=<?php echo $container_id?>"><?php echo $container_categories; ?></a></div>
                                        <h4 class="mas-title"><a href="posts.php?post_id=<?php echo $container_id?>"><?php echo $container_title; ?></a></h4>
                                        <div class="mas-details">

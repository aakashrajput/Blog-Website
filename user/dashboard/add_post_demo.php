      ...
      <form action="" method="POST" name="form1" enctype="multipart/form-data">
        ...
        if(isset($_POST['submit']) & isset($_FILES['image'])){
          ...
          //if(isset($_FILES['image'])){
                  ...
                  $file_ext = pathinfo($_FILES['wall_image']['name'], PATHINFO_EXTENSION);
                  ...
                  if(empty($category)){
                    ...
                    $query = "INSERT INTO `posts` (`id`, `date`, `title`, `sub_title`, `author`, `author_image`, `image`, `categories`,`tags`, `post_data1`, `post_data2`, `post_data3`, `views`, `status`, `wall_img`, `photo1`, `photo2`, `photo3`, `location1`, `location2`, `location3`,`location4`) VALUES (NULL, '$date', '$title', '$sub_title', 'test user', 'favicon.png', 'img.png', '$category', '$tags', '$post_data1', '$post_data2', '$post_data3', '0', 'unpublish', '$file_name', '$file_name1', '$file_name2', '$file_name3', '$location.$file_name', 'location.$file_name1', 'location.$file_name2', 'location.$file_name3')";
                  ...
                  move_uploaded_file($file_tmp1, $location.$file_name1);
                }
                  }
            ?>
        ...
        <div class="pl-lg-4">
          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="form-group">
                <label class="form-control-label">Article Wall</label>
                <input type="file" class="form-control"  name="wall_image">
              </div>
            </div>
            <div class="col-lg-4">
              <div class="form-group">
